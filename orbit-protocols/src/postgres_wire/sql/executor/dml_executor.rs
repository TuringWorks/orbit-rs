    ...
    fn new() -> Self {
        ...
        tables.insert("users".to_string(), Table {
            ...
            columns: vec![
                ...
                ColumnInfo { name: "age".to_string(), data_type: "INTEGER".to_string() },
                ColumnInfo { name: "department_id".to_string(), data_type: "INTEGER".to_string() },
            ],
            rows: vec![
                Row { values: vec![Some("1".to_string()), Some("Alice".to_string()), Some("alice@example.com".to_string()), Some("30".to_string()), Some("1".to_string())] },
                Row { values: vec![Some("2".to_string()), Some("Bob".to_string()), Some("bob@example.com".to_string()), Some("25".to_string()), Some("2".to_string())] },
                Row { values: vec![Some("3".to_string()), Some("Carol".to_string()), Some("carol@example.com".to_string()), Some("35".to_string()), Some("1".to_string())] },
                Row { values: vec![Some("4".to_string()), Some("David".to_string()), Some("david@example.com".to_string()), Some("28".to_string()), Some("3".to_string())] },
            ],
        });
        
        tables.insert("departments".to_string(), Table {
            name: "departments".to_string(),
            columns: vec![
                ColumnInfo { name: "id".to_string(), data_type: "INTEGER".to_string() },
                ColumnInfo { name: "name".to_string(), data_type: "VARCHAR".to_string() },
                ColumnInfo { name: "budget".to_string(), data_type: "DECIMAL".to_string() },
            ],
            rows: vec![
                Row { values: vec![Some("1".to_string()), Some("Engineering".to_string()), Some("1000000".to_string())] },
                Row { values: vec![Some("2".to_string()), Some("Marketing".to_string()), Some("500000".to_string())] },
                Row { values: vec![Some("3".to_string()), Some("Sales".to_string()), Some("750000".to_string())] },
            ],
        });
        ...
        tables.insert("orders".to_string(), Table {
            ...
            columns: vec![
                ...
                ColumnInfo { name: "amount".to_string(), data_type: "DECIMAL".to_string() },
                ColumnInfo { name: "order_date".to_string(), data_type: "DATE".to_string() },
            ],
            rows: vec![
                Row { values: vec![Some("1".to_string()), Some("1".to_string()), Some("100.00".to_string()), Some("2024-01-01".to_string())] },
                Row { values: vec![Some("2".to_string()), Some("2".to_string()), Some("250.50".to_string()), Some("2024-01-02".to_string())] },
                Row { values: vec![Some("3".to_string()), Some("1".to_string()), Some("75.25".to_string()), Some("2024-01-03".to_string())] },
                Row { values: vec![Some("4".to_string()), Some("3".to_string()), Some("300.00".to_string()), Some("2024-01-04".to_string())] },
                Row { values: vec![Some("5".to_string()), Some("2".to_string()), Some("125.75".to_string()), Some("2024-01-05".to_string())] },
            ],
        });
