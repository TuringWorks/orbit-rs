...
use crate::postgres_wire::sql::{ast::Statement, lexer::{Lexer, Token}};
        ...
        match &self.current_token {
            ...
            Some(token) => Err(ParseError {
                ...
                expected: vec![
                    ...
                    "GRANT".to_string(), "REVOKE".to_string(),
    ...
    fn parse_create_statement(&mut self) -> ParseResult<Statement> {
        ...
        match &self.current_token {
            ...
            Some(token) => Err(ParseError {
                ...
                position: self.position,
                expected: vec![
                    "TABLE".to_string(), "INDEX".to_string(), "VIEW".to_string(),
                    "SCHEMA".to_string(), "EXTENSION".to_string(),
                ],
                found: Some(token.clone()),
            }),
