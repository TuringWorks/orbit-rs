...
// MinIO-dependent tests have been moved to tests/integration/tiered_storage_minio_tests.rs
// Run with: cargo test -p orbit-integration-tests --features minio-tests --test tiered_storage_minio_tests -- --ignored
