...
use crate::protocols::ml::{FunctionSignature, MLFunctionRegistry, MLValue};
use crate::protocols::postgres_wire::sql::ast::FunctionCall;
...
impl SqlMlBridge {
    ...
    fn convert_sql_value_to_ml_value<'a>(
        &'a self,
        sql_value: &'a crate::protocols::postgres_wire::sql::types::SqlValue,
    ...
    fn convert_expression_to_ml_value<'a>(
        &'a self,
        expr: &'a crate::protocols::postgres_wire::sql::ast::Expression,
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = OrbitResult<MLValue>> + 'a>> {
        Box::pin(async move {
            use crate::protocols::postgres_wire::sql::ast::Expression;
    ...
    pub fn with_builtin_functions() -> Self {
        ...
        registry.register_function(MLFunctionMetadata {
            signature: FunctionSignature {
                ...
                parameters: vec![
                    crate::protocols::ml::ParameterSpec {
                        name: "features".to_string(),
                        param_type: crate::protocols::ml::FeatureType::Vector(0),
                        required: true,
                        default: None,
                    },
                    crate::protocols::ml::ParameterSpec {
                ...
                return_type: crate::protocols::ml::FeatureType::Vector(0),
        ...
        registry.register_function(MLFunctionMetadata {
            signature: FunctionSignature {
                ...
                return_type: crate::protocols::ml::FeatureType::Float64,
        ...
        registry.register_function(MLFunctionMetadata {
            signature: FunctionSignature {
                ...
                parameters: vec![
                    ...
                    crate::protocols::ml::ParameterSpec {
                        name: "mean".to_string(),
                        param_type: crate::protocols::ml::FeatureType::Float64,
                        required: false,
