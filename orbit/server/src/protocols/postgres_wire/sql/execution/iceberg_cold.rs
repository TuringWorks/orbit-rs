...
pub use crate::protocols::hybrid::FilterPredicate;
...
///
/// ```ignore
/// use crate::protocols::postgres_wire::sql::execution::{AzureConfig, StorageBackend};
...
///
/// ```ignore
/// use crate::protocols::postgres_wire::sql::execution::{AzureConfig, StorageBackend, create_rest_catalog_with_storage};
///
/// let azure_config = AzureConfig::from_connection_string(
///     "AccountName=devstoreaccount1;AccountKey=...;BlobEndpoint=http://127.0.0.1:10000/devstoreaccount1;",
///     "orbitstore".to_string()
