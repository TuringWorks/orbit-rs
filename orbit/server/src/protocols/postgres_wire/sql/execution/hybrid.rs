...
pub struct HybridStorageManager {
    ...
    cold_store: Option<
        Arc<crate::protocols::postgres_wire::sql::execution::iceberg_cold::IcebergColdStore>,
    >,
...
impl HybridStorageManager {
    ...
    pub fn with_cold_store(
        mut self,
        cold_store: Arc<
            crate::protocols::postgres_wire::sql::execution::iceberg_cold::IcebergColdStore,
        >,
    ) -> Self {
            ...
            .unwrap_or(true)
        {
            if let Some(ref cold_store) = self.cold_store {
                ...
                for arrow_batch in arrow_batches {
                    let column_batch = crate::protocols::postgres_wire::sql::execution::iceberg_cold::arrow_to_column_batch(&arrow_batch)?;
