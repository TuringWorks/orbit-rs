...
#[cfg(test)]
use crate::protocols::postgres_wire::sql::ast::{ColumnRef, JoinCondition, SelectItem, TableName};
...
mod tests {
    use super::*;
    use crate::protocols::postgres_wire::sql::optimizer::stats::{
    ...
    fn test_selectivity_estimation() {
        ...
        let expr = Expression::Binary {
            ...
            right: Box::new(Expression::Literal(
                crate::protocols::postgres_wire::sql::types::SqlValue::Integer(42),
            )),
        };
    ...
    fn test_selectivity_and_or_combination() {
        ...
        let and_expr = Expression::Binary {
            left: Box::new(Expression::Binary {
                ...
                right: Box::new(Expression::Literal(
                    crate::protocols::postgres_wire::sql::types::SqlValue::Integer(18),
                )),
            }),
