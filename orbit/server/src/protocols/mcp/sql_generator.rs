...
use crate::protocols::mcp::nlp::{QueryIntent, SqlOperation, AggregationType, ComparisonOperator, ConditionValue};
...
impl QueryBuilder {
    ...
    pub fn build_select(
        ...
        limit: &Option<u64>,
        ordering: &Option<crate::protocols::mcp::nlp::OrderingSpec>,
        ...
        if let Some(order) = ordering {
            sql.push_str(&format!(
                ...
                match order.direction {
                    crate::protocols::mcp::nlp::SortDirection::Ascending => "ASC",
                    crate::protocols::mcp::nlp::SortDirection::Descending => "DESC",
                }
            ));
        }
    ...
    pub fn build_insert(
        &self,
        intent: &QueryIntent,
        _mode: &crate::protocols::mcp::nlp::InsertMode,
    ) -> Result<GeneratedQuery, SqlGenerationError> {
        // Find table name
        let table_name = intent
            .entities
        ...
        for entity in &intent.entities {
            if matches!(entity.entity_type, crate::protocols::mcp::nlp::EntityType::Column) {
                columns.push(entity.value.clone());
            } else if matches!(entity.entity_type, crate::protocols::mcp::nlp::EntityType::Value) {
                let param_idx = parameters.len() + 1;
    ...
    pub fn build_analytical(
        &self,
        intent: &QueryIntent,
        _analysis_type: &crate::protocols::mcp::nlp::AnalysisType,
    ) -> Result<GeneratedQuery, SqlGenerationError> {
    ...
    fn format_condition(
        &self,
        cond: &crate::protocols::mcp::nlp::QueryCondition,
        _param_idx: usize,
