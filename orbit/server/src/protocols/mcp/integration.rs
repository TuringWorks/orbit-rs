...
impl OrbitMcpIntegration {
    ...
    pub async fn get_table_schema(
        &self,
        table_name: &str,
    ) -> Result<Option<crate::protocols::mcp::schema::TableSchema>, McpError> {
    ...
    fn convert_table_schema(
        &self,
        pg_schema: crate::protocols::postgres_wire::persistent_storage::TableSchema,
    ) -> crate::protocols::mcp::schema::TableSchema {
        use crate::protocols::mcp::schema::{ColumnInfo, TableSchema};
