fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match tonic_build::configure()
        ...
        Err(e) => {
            ...
            eprintln!("cargo:warning=This is likely due to missing protoc (Protocol Buffers compiler)");
            eprintln!("cargo:warning=To fix this, install protobuf-compiler or set SKIP_PROTO_BUILD=1");
            ...
            println!("cargo:warning=Continuing build without protobuf compilation for local development");
            Ok(())
        }
    }
}
