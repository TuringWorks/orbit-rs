# MCP and GraphRAG Implementation - Complete Documentation
...
- `orbit/server/src/protocols/resp/commands/graphrag.rs` - RESP protocol command handlers
...
- `orbit/server/src/protocols/graphrag/entity_extraction.rs` - LLM-based and fuzzy matching
- `orbit/server/src/protocols/graphrag/mod.rs` - Added llm_client module
- `orbit/server/src/protocols/resp/commands/mod.rs` - Enabled GraphRAG commands
