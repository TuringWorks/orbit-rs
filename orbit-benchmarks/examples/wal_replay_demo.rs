...
async fn main() -> Result<(), PersistenceError> {
    ...
    // Create a new persistence instance - this should replay the WAL
    {
        ...
        let test_keys = vec![
            ActorKey {
                actor_id: test_uuid1,
                actor_type: "actor1".to_string(),
            },
            ActorKey {
                actor_id: test_uuid2,
                actor_type: "actor2".to_string(),
            },
            ActorKey {
                actor_id: test_uuid3,
                actor_type: "actor3".to_string(),
            },
        ];
        ...
        println!(
            "✓ New insert after recovery successful - Latency: {:?}",
            metrics.latency
        );
    }
